...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        // Check to see if local notifications permission was changed
        ...
        notificationsCenter.getNotificationSettings { (settings) in
            ...
            if (settings.authorizationStatus == .authorized)
            {
                ...
                // Clear all local notifications if turn off by user in settings
                let defaults = UserDefaults.standard
                defaults.set(false, forKey: "LocalNotifications")
    ...
    func createLocalNotification() {
        ...
        notificationContent.subtitle = "This is a friendly reminder"
        notificationContent.body = "You have the following classes to complete."
        ...
        // Create request
        let request = UNNotificationRequest(identifier: "LocalNotificationsIdentifier", content: notificationContent, trigger: calendarTrigger)
